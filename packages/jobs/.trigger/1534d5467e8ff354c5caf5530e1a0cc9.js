...
var require_v3 = __commonJS({
  "../../node_modules/@trigger.dev/core/dist/v3/index.js"(exports2) {
    ...
    var _ApiClient = class _ApiClient {
      constructor(baseUrl3, accessToken, requestOptions = {}) {
...
function timezones(options) {
  const baseUrl3 = import_v32.apiClientManager.baseURL;
  if (!baseUrl3) {
    throw apiClientMissingError();
  }
  return (0, import_zodfetch.zodfetch)(import_v32.TimezonesResult, `${baseUrl3}/api/v1/timezones${options?.excludeUtc === true ? "?excludeUtc=true" : ""}`, {
    method: "GET",
    headers: {
      "Content-Type": "application/json"
    }
...
function AccountDeletionsNotice() {
  return /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(import_components2.Html, { children: /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)(import_components2.Tailwind, { children: [
    ...
    /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(import_components2.Preview, { children: "Important: Your Account Needs Confirmation" }),
    /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(
              ...
              /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)(
                import_components2.Text,
                {
                  ...
                  children: [
                    ...
                    " ",
                    /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(import_components2.Link, { href: `${baseUrl2}/auth`, children: "here" }),
                    "."
                  ]
                }
              ),
...
var renderAccountDeletionsNotice = (0, import_components2.render)(
...
var accountDeletionsNotice = task({
  ...
  run: async (payload, { ctx }) => {
    ...
    if (email) {
      const emailHtml = await (0, import_components3.render)(
...
var deleteUnconfirmedEmails = task({
  ...
  run: async (payload, { ctx }) => {
    ...
    if (email) {
      const emailHtml = await (0, import_components4.render)(
...
//# sourceMappingURL=1534d5467e8ff354c5caf5530e1a0cc9.js.map